    ...
    return (
      <div className={classnames("chatroom", isOpen ? "open" : "closed")}>
        ...
        <div className="container">
          <div style={{display:"flex",justifyContent: "center", marginTop:"20px", colorBackground:"blue", width:"100%", height:"30vh"}}>
            <div className="chats" style={{display:"block", width:"100vh"}}  ref={this.chatsRef}>
          ...
          <div  classname="chats" style={{ height:"40vh", marginBottom:"80px", display:"flex", justifyContent: "space-around" }} ref={this.chatsRef}>
             {messageGroups.map((group, i) => 
              group.map(m=>
                m.message.type==="image"?<img style={{height:"35vh"}} src={`./src/imgs/${m.message.image}`}/>:null)
              )
             }
          </div>
          
          <form className="mic" onSubmit={this.handleSubmitMessage}>
